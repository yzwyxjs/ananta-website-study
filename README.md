...
基于 Vue 3 + TypeScript + Vite 对[《无限大》(ANANTA) 官方网站](https://ananta.163.com/)的前端效果进行学习性复刻。
...
逆向还原了原站的多层容器嵌套动画：外层容器控制整体位移，内层容器控制缩放，各气泡独立控制透明度与缩放，通过 GSAP Timeline 的时间偏移精确编排时序。
...
1. 本项目是**个人学习项目**，目的是研究和学习现代网页滚动动效的实现方式，与网易公司及 Naked Rain 工作室无任何关联。
